...
TOMBSTONE JAILBREAK (Starter Project) - v. 1.0 
...
8) Click on either the scene called "Tombstone".
...
8) If the scene is not in the build list, click "Add Open 
   Scenes". Tombstone should appear checked. 
...
(1) https://assetstore.unity.com/packages/3d/environments/historic/polygon-western-low-poly-3d-art-by-synty-112212
(2) https://coderespawn.com
(3) Outlaws by LucasArts
